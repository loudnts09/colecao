            ...
            @forelse($dados as $dado)
                <tr>
                    ...
                    <td width="15%">
                        ...
                        @else
                            <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modelCategoriaDelete" data-bs-categoria-id="{{ $dado->id }}" data-bs-categoria-nome="{{ $dado->nome }}"><i class="bi bi-trash"></i> Excluir</button>
                        @endif
                    </td>
                </tr>
            @empty
...
@section('rodape')
    <nav class="navbar bg-primary" data-bs-theme="dark">
        <div class="container-fluid">
            <h5 class="mb-0 text-white">CATEGORIAS - {{ date('Y') }}</h5>
        </div>
    </nav>
